  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        {/* SECTION HEADER */}
        <div className="text-center mb-16">
          <p className="text-accent font-semibold mb-2">Our Courses</p>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Featured Learning Paths
          </h2>
          <p className="text-muted-foreground max-w-3xl mx-auto">
            Choose from our specialized programs for academic excellence and
            future-ready skills.
          </p>
        </div>
          ...
          {courses.map((course, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button
                  onClick={() => handleEnroll(course.id)}
                  className="w-full flex items-center justify-center gap-2 bg-foreground/5 hover:bg-primary hover:text-primary-foreground py-3 rounded-xl font-semibold transition"
                >
                  Enroll Now
